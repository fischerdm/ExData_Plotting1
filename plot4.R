...
# plot topright
plot(data$Voltage, col="black", ylab="Voltage", xaxt="n", xlab = "datetime", type = "l")
axis(side=1, at=c(position1, position2), labels=c(weekdays, "Sat"))
...
# bottomright
plot(data$Global_reactive_power, col="black", ylab="Global_reactive_power", xaxt="n", xlab = "datetime", type = "l")
axis(side=1, at=c(position1, position2), labels=c(weekdays, "Sat"))
